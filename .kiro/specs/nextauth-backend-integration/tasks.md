...
- [ ] 1.1 Fix NEXTAUTH_SECRET in environment configuration
  - Generate and set a proper 32+ character NEXTAUTH_SECRET in `.env.local`
  - _Requirements: 2.2_

- [x] 2. Create authentication service utility
  - [x] 2.1 Create `frontend/src/lib/auth.ts` with authentication utilities
    - Implement URL construction from environment variables
    - Add authentication request handling
    - Include error handling and validation
    - _Requirements: 1.1, 1.3, 3.1_

  - [x] 2.2 Write property test for authentication URL correctness
...
- [x] 3. Update NextAuth configuration
  - [x] 3.1 Update `frontend/src/app/api/auth/[...nextauth]/route.ts`
...
- [x] 5. Add development logging and debugging
  ...
  - [x]* 5.2 Write property test for development logging
...
- [ ] 7. Fix backend API URL configuration
  - Update `.env.local` to use correct backend port (8000 instead of 8001)
...
- Most implementation work is complete - only configuration fixes remain
